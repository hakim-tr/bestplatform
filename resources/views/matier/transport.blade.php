...
<body>
@extends('layouts.app')
<h1>هيا نتعرف على وسائل النقل 🦁🐘</h1>
...
// animals
const animals = [
  { name: "Voiture", img: "image/transport/car.png" },
  { name: "Bus", img: "image/transport/bus.png" },
  { name: "Vélo", img: "image/transport/bike.png" },
  { name: "Avion", img: "image/transport/plane.png" },
  { name: "Train", img: "image/transport/train.png" },
  { name: "Moto", img: "image/transport/motorcycle.png" },
  { name: "Camion", img: "image/transport/truck.png" },
  { name: "Taxi", img: "image/transport/taxi.png" },
  { name: "Bateau", img: "image/transport/boat.png" },
  { name: "Hélicoptère", img: "image/transport/helicopter.png" },
  { name: "Trotinette", img: "image/transport/scooter.png" },
  { name: "Caravane", img: "image/transport/caravan.png" },
  { name: "Brouette", img: "image/transport/wheelbarrow.png" },
  { name: "Ambulance", img: "image/transport/ambulance.png" },
  { name: "Police", img: "image/transport/police.png" },
];
