...
// Fruits
const fruits = [
  { name: "pomme", img: "image/fruits/apple.png" },
  { name: "banane", img: "image/fruits/banana.png" },
  { name: "orange", img: "image/fruits/orange.png" },
  { name: "raisin", img: "image/fruits/grapes.png" },
  { name: "pastèque", img: "image/fruits/watermelon.png" },
  { name: "fraise", img: "image/fruits/strawberry.png" },
  { name: "poire", img: "image/fruits/pear.png" },
  { name: "citron", img: "image/fruits/lemon.png" },
  { name: "mangue", img: "image/fruits/mango.png" },
  { name: "ananas", img: "image/fruits/pineapple.png" },
  { name: "cerise", img: "image/fruits/cherry.png" },
  { name: "kiwi", img: "image/fruits/kiwi.png" },
  { name: "pêche", img: "image/fruits/peach.png" },
  { name: "prune", img: "image/fruits/plum.png" },
  { name: "framboise", img: "image/fruits/raspberry.png" },
];
...
totalEl.innerText = fruits.length;

function shuffle(arr){ return arr.sort(()=>Math.random()-0.5); }

function load(){
  const q = fruits[index];
  fruitImg.src = q.img;
  msg.innerText = "";
  ...
  if(level===1){
    ...
    while(answers.length<4){
      let r = fruits[Math.floor(Math.random()*fruits.length)].name;
...
function updateBar(){
  bar.style.width = ((index/fruits.length)*100)+"%";
}

function speak(){
  const u = new SpeechSynthesisUtterance(fruits[index].name);
  u.lang = "fr-FR";
